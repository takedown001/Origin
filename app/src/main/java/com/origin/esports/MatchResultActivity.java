...
import com.origin.esports.adapter.MatchResultAdapter;
import com.origin.esports.data.MatchResult;
...
public class MatchResultActivity extends AppCompatActivity {
    ...
    private static final String url = URL.ResultAct;

    // JSON Node names
    private static final String TAG_SUCCESS = URL.SUCCESS;
    private static final String TAG_RAJANR = "match";
    private static final String TAG_RAJANRWON = "won";
    ...
    class OneLoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
          ...
          String rq = null;
            ...
            try {
                ...
                rq = jsonParser.makeHttpRequest(url+"?rnd="+i1, params);
        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
            if (s == null || s.isEmpty()) {
                Toast.makeText(MatchResultActivity.this, "Server Error", Toast.LENGTH_LONG).show();
                return;
            }
                ...
                public void run() {
                    try {
                        ...
                        if (!Helper.verify(decData, ack.get("Sign").toString(), JSONParserString.publickey)) {
                            Toast.makeText(MatchResultActivity.this, "Something Went Wrong", Toast.LENGTH_LONG).show();
                            return;
                        } else {
                            ...
                            if (success == 1) {
                                ...
                                for (int i = 0; i < jsonarraywon.length(); i++) {
                                    ...
                                    map.put("pubgusername", c.getString("pubgusername"));
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; i < offersListWon.size(); i++) {
                            ...
                            matchresult.setPlayerName(offersListWon.get(i).get("pubgusername"));
                        ...
                        for (int i = 0; i < offersList.size(); i++) {
                            ...
                            matchresult.setPlayerName(offersList.get(i).get("pubgusername"));
